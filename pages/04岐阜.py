...
# チェックボックスの設定
st.sidebar.write("### 岐阜河川")
riv1 = st.sidebar.checkbox("稲荷")
if riv1:
    grfdrw("inari")
riv2 = st.sidebar.checkbox("美濃")
if riv2:
    grfdrw("mino")
riv3 = st.sidebar.checkbox("板取川")
if riv3:
    grfdrw("horado")
riv4 = st.sidebar.checkbox("益田川")
if riv4:
    grfdrw("jouro")
riv5 = st.sidebar.checkbox("付知川")
if riv5:
    grfdrw("tuketi")
riv6 = st.sidebar.checkbox("高原川")
if riv6:
    grfdrw("takahara")
